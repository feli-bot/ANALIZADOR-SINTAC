...
while salir == False:
    ...
    print ("se ah establecido la coneccion ")
    ...
    while True:
        ...
        if message == 'adios' or message == 'Adios' or message == 'ADIOS':
        ...
        elif message == 'buenas' or message == 'buenas' or message == 'BUENAS':                                         
            ...
            message = 'elija una opcion en la lista'            
            conexion.send(message.encode())

conexion.close()
print("sea finalizado el servidor ")